...
Only years later, when combining the data, it was found that the changes were significant [[Preusser et al., 1982]](#preusser1982effect).
...
To see how the plots are generated visit the [R Markdown file](/notebooks/power.html).
...
![Data after multiple years](/images/power/multiple-years.svg)
</center>
...
![Data after many years](/images/power/many-years.svg)
</center>

<center>
*Histogram for the number of accidents over 1000 years*
![Data after many years](/images/power/many-many-years.svg)
</center>
...
<center>
<i>Galton box (source: Wikimedia Commons)</i><br />
![](/images/galton-box.svg)
</center>
...
Note that in general in statistics, "Greek letters for measures of the population (called 'parameters') and Latin letters are used for measures of one or more samples (called 'statistics')" [[Smith, 2008]](#smith2008symbols).
...
![Comparing two binomial distributions](/images/power/binomial-and-normal-distributions.svg)
</center>
...
![](/images/power/one-sample-distribution.svg)
</center>
...
![](/images/power/two-sample-distribution.svg)
</center>
...
![](/images/power/two-sample-without-mean.svg)
</center>
...
![](/images/power/two-sample-without-sd.svg)
</center>
...
![](/images/power/normal-and-t-distributions.svg)
</center>
...
![](/images/power/t-one-versus-two-sided.svg)
</center>
...
![](/images/power/t-and-critical-values.svg)
</center>
...
![](/images/power/power-one-sample.svg)
</center>
...
![](/images/power/power-two-sample.svg)
</center>

The *power* "describes the probability that a study will detect an effect when there is a genuine effect to be detected" [[Ellis, 2010]](#ellis2010essential).
...
One way to calculate the effect size for the t-test is by using Cohen's d [[Cohen, 1992]](#cohen1992power).
...
Ellis [(2010)](#ellis2010essential) argues that "effect size estimates need to be interpreted separately from tests of statistical significance".
For example, a small effect size of r = 0.04 might be huge if is it about Propranolol and heart attack survival.
In effect it could mean a "4% decrease in heart attacks for people at risk" [[Ellis, 2010]](#ellis2010essential).
...
Cohen would classify this as a medium effect [[Cohen, 1992]](#cohen1992power).
...
Ellis [(2010)](#ellis2010essential) provides various options for predicting effect sizes, namely
...
For a more detailed description see Ellis [(2010)](#ellis2010essential).

### References
{{< id cohen1992power >}}
Cohen, J. (1992). A power primer. Psychological bulletin, 112(1), 155.

{{< id ellis2010essential >}}
Ellis, P. D. (2010).
The Essential Guide to Effect Sizes.
Cambridge University Press.

{{< id preusser1982effect >}}
